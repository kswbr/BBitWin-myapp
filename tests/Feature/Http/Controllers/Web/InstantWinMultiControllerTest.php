...
class InstantWinMultiControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testRunPtnWinner()
    {
        ...
        $campaign = factory(Campaign::class)->create(["project" => $project, "code" => "campaign_code"]);
        $lose_lotteries = factory(Lottery::class,10)->create(["campaign_code" => $campaign->code, "rate" => 0]);
        $win_lottery = factory(Lottery::class)->create(["campaign_code" => $campaign->code, "rate" => 100]);
    ...
    public function testRunPtnPrevWinner()
    {
        ...
        $project = $this->projectService->getCode();
        $campaign = factory(Campaign::class)->create(["project" => $project, "code" => "campaign_code"]);
        $lottery = factory(Lottery::class)->create(["campaign_code" => $campaign->code, "code" => "lottery_code", "rate" => 0]);
    ...
    public function testRunPtnWinPostingCompleted()
    {
        ...
        $project = $this->projectService->getCode();
        $campaign = factory(Campaign::class)->create(["project" => $project, "code" => "campaign_code"]);
        $lottery = factory(Lottery::class)->create(["campaign_code" => $campaign->code, "code" => "lottery_code", "rate" => 100]);
    ...
    public function testRunPtnZeroRemaining()
    {
        ...
        $project = $this->projectService->getCode();
        $campaign = factory(Campaign::class)->create(["project" => $project, "code" => "campaign_code"]);
        $lottery = factory(Lottery::class)->create(["campaign_code" => $campaign->code, "code" => "lottery_code", "rate" => 100, "limit" => 1]);
